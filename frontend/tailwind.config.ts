  ...
  theme: {
    extend: {
      backgroundImage: {
        ...
        "conic-gradient":
          //   "conic-gradient(from 0deg, rgba(62, 144, 241, 0.4), rgba(7, 16, 45, 0.2),rgba(0, 0, 0, 0), rgba(253, 152, 155, 0.4),rgba(73, 38, 43, 0.2),rgba(0, 0, 0, 0),rgba(137, 112, 241, 0.54),rgba(55, 40, 94, 0.3),rgba(0, 0, 0, 0))"
          "conic-gradient(from 0deg, rgba(253, 152, 155, 0.4),rgba(73, 38, 43, 0.2),rgba(62, 144, 241, 0.4), rgba(7, 16, 45, 0.2) ,rgba(137, 112, 241, 0.54),rgba(55, 40, 94, 0.3))",
      },
      spacing: {
